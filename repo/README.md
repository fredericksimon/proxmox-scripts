...
```bash
curl -sL https://raw.githubusercontent.com/fredericksimon/proxmox-scripts/main/repo/create.sh | bash -s
```
...
| --hostname    | repo                 | hostname of the container                              |
...
```bash
curl -sL https://raw.githubusercontent.com/fredericksimon/proxmox-scripts/main/repo/create.sh | bash -s -- --cores 4
```
...
```bash
wget --no-cache -qO - https://raw.githubusercontent.com/fredericksimon/proxmox-scripts/main/repo/setup.sh | sh
```
